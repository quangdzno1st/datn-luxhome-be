...
class MimeType
{
    protected static $extensionToMimeTypeMap = [
        ...
        'docx' => 'application/vnd.openxmlformats-officedocument.wordprocessingml.word_group',
        'docm' => 'application/vnd.ms-word.template.macroEnabled.12',
        'dot' => 'application/msword',
        'dotx' => 'application/vnd.openxmlformats-officedocument.wordprocessingml.word_group',
