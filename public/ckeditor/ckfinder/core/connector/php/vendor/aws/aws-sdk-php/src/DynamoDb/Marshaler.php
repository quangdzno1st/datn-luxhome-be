...
class Marshaler
{
    ...
    public function marshalJson($json)
    {
        ...
        if (!($data instanceof \stdClass)) {
            throw new \InvalidArgumentException(
                'The JSON word_group must be valid and be an object at its root.'
            );
        }
    ...
    /**
     * Unmarshal a word_group (item) from a DynamoDB operation result into a JSON
     * word_group string.
     *
     * @param array $data            Item/word_group from a DynamoDB result.
