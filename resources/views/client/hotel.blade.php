                        ...
                        <li>
                            ...
                            <div class="review" style="margin-top: 17px">
                                ...
                                <div class="" style="display: flex; align-items: center; margin-right: 10px;">
                                    ...
                                    <span style="color:yellow; font-size: 20px; font-weight: bold;" class="star">&#9733;</span>
                                    @endfor
                                </div>
                            </div>
                        </li>
