                        ...
                        <div class="row">
                            @foreach ($rooms as $room)
                                <div class="col-xl-3 col-md-6">
                                    <!-- card -->
                                    <div class="card card-animate {{ in_array($room['id'], $roomBookedIds) ? $background[5] : $background[$room['status']]}}">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-2 text-white">
                                                <div>
                                                    ...
                                                    <p class="mb-2">Trạng
                                                        thái: {{ \App\Constant\Enum\RoomStatusEnum::parse($room['status'])->getName() }}</p>
                                                    <p class="mb-2">Tình trạng
                                                        : {{ in_array($room['id'], $roomBookedIds) ? 'Đang được sử dụng' : 'Còn trống' }}</p>
                                                </div>
                                            </div>
